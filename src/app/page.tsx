        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden lg:flex items-center gap-8 text-sm font-royal font-light tracking-wide">
              {[uiCopy.nav.home, uiCopy.nav.destinations, uiCopy.nav.collections, uiCopy.nav.contact].map((item) => (
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              >
                {[uiCopy.nav.home, uiCopy.nav.destinations, uiCopy.nav.collections, uiCopy.nav.contact].map((item, i) => (
                  <motion.div
                    key={item}
        ...
        <div className="relative z-20 container mx-auto px-6 text-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-9xl font-display font-medium leading-[0.9] mb-12 tracking-tighter shadow-luxury-glow">
              {uiCopy.hero.title.split('...')[0]} <span className="gold-text italic">{uiCopy.hero.title.split('...')[1]}</span>
            </h1>
      ...
      <section className="py-40 bg-luxury-obsidian/50 relative overflow-hidden border-y border-luxury-gold/5">
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
             {uiCopy.sovereign_trust.pillars.map((pillar: any, i: number) => (
               <motion.div
                 key={i}
                 initial={{ opacity: 0, y: 30 }}
                 whileInView={{ opacity: 1, y: 0 }}
